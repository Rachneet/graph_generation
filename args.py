class Args():
    def __init__(self):
        ...
        # self.graph_type = 'barabasi_density'
        self.graph_type = 'barabasi_small_completion'
        # self.graph_type = 'primary_school'
        ...
        self.max_prev_node = None #for community  # max previous node that looks back
        self.nodes_removed = None
        ...
        self.fname_validate = self.note + '_' + self.graph_type + '_' + str(self.num_layers) + '_' + str(
            self.hidden_size_rnn) + '_validate_'
